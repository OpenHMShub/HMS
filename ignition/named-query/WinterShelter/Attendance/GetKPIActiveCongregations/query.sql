...
SELECT COUNT(DISTINCT locationName)
FROM
(
...
END as checkinDate
FROM shelter.ScheduleParticipant sp, participant.Participant p, humans.Human h, shelter.location l, 
humans.Gender g, participant.Dashboard pd, shelter.locationSeasonal ls
