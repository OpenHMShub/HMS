...
SELECT
	...
	,(SELECT COUNT(id) FROM participant.services WHERE participantId = h.participant_id) as 'NoOfServices'
	,(SELECT COUNT(bedId) FROM lodging.BedLog WHERE participantId = h.participant_id) as 'NoOfShelters'
...
ORDER BY
	first_name,middle_name,last_name,nick_name,ssn,race,dob
